...
void setupArduino() {
  /* Bottom Level */
	...
	lowerLevel->attachPoint(make_shared<ArduinoPoint>(90, 65, 90, 0, ArduinoPoint::RIGHT));
	...
	middleLevel->attachPoint(make_shared<ArduinoPoint>(75, 70, 35, 0, ArduinoPoint::RIGHT));
